...
searched_file_ext = [".png",".pdf",".txt"] #change or add here as many file ext as you need
counter = []
...
for i in range(0,len(searched_file_ext)):
    file.write("<p>Found " +str(counter)+ " "+searched_file_ext[i]+" file(s)<br>Last log operation: <b>"+now+"</b></p>")
